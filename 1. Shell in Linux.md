...
* **Shell** được chia làm 2 loại:
   ...
   * Graphical shell
 ## Command Line Shell
 **Shell** có thể được truy cập bởi người dùng bằng cách sử dụng **command line** interface. Một chương trình đặc biệt có tên Terminal trong linux/ macOS hoặc Command Prompt trong Windows OS, được cung cấp để nhập vào các lệnh có thể đọc được của người dùng như "cat", "ls" etc. và sau đó nó được thực thi. Kết quả sau đó được hiển thị trên Terminal, một Terminal trong hệ thống Ubuntu 22.04 trông sẽ như thế này:
